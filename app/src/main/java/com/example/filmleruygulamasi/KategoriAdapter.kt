...
RecyclerView.Adapter<KategoriAdapter.CardTsarimTutucu>(){

    inner class CardTsarimTutucu(tasarim: View):RecyclerView.ViewHolder(tasarim){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardTsarimTutucu {
        val tasarim = LayoutInflater.from(mContext).inflate(R.layout.kategori_card_tasarim,parent,false)
        return CardTsarimTutucu(tasarim)
    }
    ...
    override fun onBindViewHolder(holder: CardTsarimTutucu, position: Int) {
